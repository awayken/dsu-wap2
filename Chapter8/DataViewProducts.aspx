<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DataViewProducts.aspx.vb" Inherits="Chapter8.DataViewProducts" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>DataViewProducts</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="MyDG" style="Z-INDEX: 103; LEFT: 153px; POSITION: absolute; TOP: 111px" runat="server"
