<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Ch8Proj4.aspx.vb" Inherits="Chapter8.Ch8Proj4" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Ch8Proj4</title>
		<meta content="Microsoft Visual Studio.NET 7.0" name="GENERATOR">
		<meta content="Visual Basic 7.0" name="CODE_LANGUAGE">
		<meta content="JavaScript" name="vs_defaultClientScript">
		<meta content="http://schemas.microsoft.com/intellisense/ie5" name="vs_targetSchema">
		<LINK href="Ch8Proj4.css" type="text/css" rel="stylesheet">
	</HEAD>
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="lblCompanyName" style="Z-INDEX: 104; LEFT: 206px; POSITION: absolute; TOP: 16px"
				...
				runat="server" CssClass="MyStyleHead_Medium">Label</asp:label><asp:datalist id="SupplierList" style="Z-INDEX: 108; LEFT: 12px; POSITION: absolute; TOP: 256px"
				...
				<SelectedItemTemplate>
					<table>
						<tr>
							<td>
								<asp:HyperLink CssClass="MenuSelected" id="Hyperlink7" ImageUrl='<%# "images/Northwind/bullet.gif" %>' NavigateUrl='<%# "Ch8Proj4.aspx?SupplierID=" & DataBinder.Eval(Container.DataItem, "SupplierID") & "&selItem=" & Container.ItemIndex &  "&Show=prodlist" %>' runat="server" />
							</td>
							<td>
								<asp:HyperLink CssClass="MenuSelected" id="HyperLink2" Text='<%# DataBinder.Eval(Container.DataItem, "CompanyName") %>' NavigateUrl='<%# "Ch8Proj4.aspx?SupplierID=" & DataBinder.Eval(Container.DataItem, "SupplierID") & "&selItem=" & Container.ItemIndex &  "&Show=prodlist" %>' runat="server" />
						</tr>
					</table>
				</SelectedItemTemplate>
				<ItemTemplate>
					<table>
						<tr>
							<td>
								<asp:HyperLink CssClass="MenuSelected" id="Hyperlink1" ImageUrl='<%# "images/Northwind/bullet.gif" %>' NavigateUrl='<%# "Ch8Proj4.aspx?SupplierID=" & DataBinder.Eval(Container.DataItem, "SupplierID") & "&selItem=" & Container.ItemIndex &  "&Show=prodlist" %>' runat="server" />
							</td>
							<td>
								<asp:HyperLink CssClass="MenuSelected" id="Hyperlink3" Text='<%# DataBinder.Eval(Container.DataItem, "CompanyName") %>' NavigateUrl='<%# "Ch8Proj4.aspx?SupplierID=" & DataBinder.Eval(Container.DataItem, "SupplierID") & "&selItem=" & Container.ItemIndex &  "&Show=prodlist" %>' runat="server" />
						</tr>
					</table>
				</ItemTemplate>
				...
				<SelectedItemTemplate>
					<table>
						<tr>
							<td>
								<asp:HyperLink CssClass="MenuSelected" id="Hyperlink6" ImageUrl='<%# "images/Northwind/bullet.gif" %>' NavigateUrl='<%# "Ch8Proj4.aspx?ProductID=" & DataBinder.Eval(Container.DataItem, "ProductID") & "&SupplierID=" & DataBinder.Eval(Container.DataItem, "SupplierID") & "&CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prod"  %>' runat="server" />
							</td>
							<td>
								<asp:HyperLink runat="server" id="Hyperlink8" CssClass="MenuSelected" Text='<%# DataBinder.Eval(Container.DataItem, "ProductName")%>' NavigateUrl='<%# "Ch8Proj4.aspx?ProductID=" & DataBinder.Eval(Container.DataItem, "ProductID") & "&SupplierID=" & DataBinder.Eval(Container.DataItem, "SupplierID") & "&CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prod"  %>' />
							</td>
						</tr>
					</table>
				</SelectedItemTemplate>
				<ItemTemplate>
					<table border="0">
						<tr>
							<td>
								<asp:HyperLink CssClass="MenuSelected" id="Hyperlink5" ImageUrl='<%# "images/Northwind/bullet.gif" %>' NavigateUrl='<%# "Ch8Proj4.aspx?ProductID=" & DataBinder.Eval(Container.DataItem, "ProductID") & "&SupplierID=" & DataBinder.Eval(Container.DataItem, "SupplierID") & "&CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prod"  %>' runat="server" />
							</td>
							<td>
