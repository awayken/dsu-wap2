<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Ch8Case3_AddCat.aspx.vb" Inherits="Chapter8.Ch8Case3_AddCat"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Ch8Case3_AddCat</title>
	...
	<body MS_POSITIONING="GridLayout" style="COLOR: white; FONT-FAMILY: Trebuchet MS; BACKGROUND-COLOR: #dc6331">
		<form id="Form1" method="post" runat="server">
			...
			<asp:TextBox id="txtAdd" style="Z-INDEX: 106; LEFT: 200px; POSITION: absolute; TOP: 104px" runat="server"
				Font-Names="trebuchet ms"></asp:TextBox>
			<asp:Button id="btnAdd" style="Z-INDEX: 107; LEFT: 352px; POSITION: absolute; TOP: 104px" runat="server"
				Font-Names="trebuchet ms" Text="Add Category"></asp:Button>
			<asp:Label id="Label1" style="Z-INDEX: 108; LEFT: 200px; POSITION: absolute; TOP: 72px" runat="server">Add a new category.</asp:Label>
			<asp:Label id="lblStatus" style="Z-INDEX: 109; LEFT: 200px; POSITION: absolute; TOP: 144px"
