<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DataReaderProducts.aspx.vb" Inherits="Chapter8.DataReaderProducts" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>DataReaderProducts</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:image id="LargeImage" style="Z-INDEX: 107; LEFT: 148px; POSITION: absolute; TOP: 96px"
				...
				<SelectedItemTemplate>
					<asp:HyperLink CssClass="MenuSelected" id="HyperLink2" Text='<%# DataBinder.Eval(Container.DataItem, "CategoryName") %>' NavigateUrl='<%# "DataReaderProducts.aspx?CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=cat" %>' runat="server" />
				</SelectedItemTemplate>
				<ItemTemplate>
					<asp:HyperLink CssClass="MenuUnselected" id="HyperLink1" Text='<%# DataBinder.Eval(Container.DataItem, "CategoryName") %>' NavigateUrl='<%# "DataReaderProducts.aspx?CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=cat" %>' runat="server" />
				</ItemTemplate>
					...
					<table border="0" width="300">
						<tr style="MyClass">
							...
							<td width="180" valign="middle" align="center">
								<asp:HyperLink runat="server" id="Hyperlink5" ImageUrl='<%# "images/SubCatThumbnails/" & DataBinder.Eval(Container.DataItem, "Thumbnail") %>' CssClass="MenuSelected" NavigateUrl='<%# "DataReaderProducts.aspx?CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&SubCatID=" & DataBinder.Eval(Container.DataItem, "SubCategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prodlist"  %>'>
								</asp:HyperLink>
								<br>
				...
				<ItemTemplate>
					<table border="0" width="300">
						<tr style="MyClass">
							...
							<td width="180" valign="middle" align="center">
								<asp:HyperLink runat="server" id="HyperLink3" ImageUrl='<%# "images/ProductThumbnails/" & DataBinder.Eval(Container.DataItem, "Thumbnail") %>' CssClass="MenuSelected" NavigateUrl='<%# "DataReaderProducts.aspx?ProdID=" & DataBinder.Eval(Container.DataItem, "ProductID") & "&CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&SubCatID=" & DataBinder.Eval(Container.DataItem, "SubCategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prod"  %>'>
								</asp:HyperLink>
								<br>
								<asp:HyperLink runat="server" id="HyperLink4" CssClass="MenuSelected" Text='<%# DataBinder.Eval(Container.DataItem, "ModelName")%>' NavigateUrl='<%# "DataReaderProducts.aspx?ProdID=" & DataBinder.Eval(Container.DataItem, "ProductID") & "&CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&SubCatID=" & DataBinder.Eval(Container.DataItem, "SubCategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prod"  %>'>
								</asp:HyperLink>
							</td>
						</tr>
					</table>
