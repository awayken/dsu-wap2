<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DataReaderDisplay.aspx.vb" Inherits="Chapter8.DataReaderDisplay" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>DataReaderDisplay</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:image id="LargeImage" style="Z-INDEX: 107; LEFT: 148px; POSITION: absolute; TOP: 96px"
				...
				Font-Names="Bookman Old Style" ForeColor="#004040" Font-Size="X-Large" Font-Italic="True">Welcome to Tara Store Online</asp:label><asp:datalist id="MyCatList" style="Z-INDEX: 102; LEFT: 29px; POSITION: absolute; TOP: 106px"
				runat="server" EnableViewState="False" width="154px" cellpadding="3" Height="128px">
				<SelectedItemTemplate>
					<asp:HyperLink CssClass="MenuSelected" id="HyperLink2" Text='<%# DataBinder.Eval(Container.DataItem, "CategoryName") %>' NavigateUrl='<%# "DataReaderDisplay.aspx?CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=cat" %>' runat="server" />
				</SelectedItemTemplate>
				<ItemTemplate>
					<asp:HyperLink CssClass="MenuUnselected" id="HyperLink1" Text='<%# DataBinder.Eval(Container.DataItem, "CategoryName") %>' NavigateUrl='<%# "DataReaderDisplay.aspx?CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=cat" %>' runat="server" />
				</ItemTemplate>
			</asp:datalist><asp:datalist id="MySubCatList" style="Z-INDEX: 105; LEFT: 152px; POSITION: absolute; TOP: 302px"
				runat="server" RepeatDirection="Horizontal" RepeatColumns="2">
				<ItemTemplate>
					<table border="0" width="300">
						<tr style="MyClass">
							...
							<td width="180" valign="middle" align="center">
								<asp:HyperLink runat="server" id="Hyperlink5" ImageUrl='<%# "images/SubCatThumbnails/" & DataBinder.Eval(Container.DataItem, "Thumbnail") %>' CssClass="MenuSelected" NavigateUrl='<%# "DataReaderDisplay.aspx?CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&SubCatID=" & DataBinder.Eval(Container.DataItem, "SubCategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prodlist"  %>'>
								</asp:HyperLink>
								<br>
								<asp:HyperLink runat="server" id="Hyperlink6" CssClass="MenuSelected" Text='<%# DataBinder.Eval(Container.DataItem, "SubCategoryName")%>' NavigateUrl='<%# "DataReaderDisplay.aspx?CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&SubCatID=" & DataBinder.Eval(Container.DataItem, "SubCategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prodlist"  %>'>
								</asp:HyperLink>
							</td>
						</tr>
					</table>
				...
				<ItemTemplate>
					<table border="0" width="300">
						<tr style="MyClass">
							...
							<td width="180" valign="middle" align="center">
								<asp:HyperLink runat="server" id="HyperLink3" ImageUrl='<%# "images/ProductThumbnails/" & DataBinder.Eval(Container.DataItem, "Thumbnail") %>' CssClass="MenuSelected" NavigateUrl='<%# "DataReaderDisplay.aspx?ProdID=" & DataBinder.Eval(Container.DataItem, "ProductID") & "&CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&SubCatID=" & DataBinder.Eval(Container.DataItem, "SubCategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prod"  %>'>
								</asp:HyperLink>
								<br>
								<asp:HyperLink runat="server" id="HyperLink4" CssClass="MenuSelected" Text='<%# DataBinder.Eval(Container.DataItem, "ModelName")%>' NavigateUrl='<%# "DataReaderDisplay.aspx?ProdID=" & DataBinder.Eval(Container.DataItem, "ProductID") & "&CatID=" & DataBinder.Eval(Container.DataItem, "CategoryID") & "&SubCatID=" & DataBinder.Eval(Container.DataItem, "SubCategoryID") & "&selItem=" & Container.ItemIndex &  "&Show=prod"  %>'>
								</asp:HyperLink>
							</td>
						</tr>
					</table>
			...
			<asp:datalist id="MyProduct" style="Z-INDEX: 106; LEFT: 152px; POSITION: absolute; TOP: 308px"
