<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ASPValidateForm.aspx.vb" Inherits="Chapter3.ASPValidateForm" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<FORM id="Form1" method="post" runat="server">
			...
			<asp:RegularExpressionValidator id="RegularExpressionValidator2" style="Z-INDEX: 116; LEFT: 476px; POSITION: absolute; TOP: 254px"
				runat="server" Width="121px" Height="47px" Font-Names="Trebuchet MS" Font-Size="X-Small" ErrorMessage="Please submit the <br> e-mail address as yourname@yourcompany.com "
			...
			<asp:TextBox id="txtEmail" style="Z-INDEX: 111; LEFT: 286px; POSITION: absolute; TOP: 245px"
				runat="server"></asp:TextBox>
			<asp:imagebutton id="btnSubmit" style="Z-INDEX: 112; LEFT: 289px; POSITION: absolute; TOP: 303px"
				runat="server" ImageUrl="images/submitblue.gif" ImageAlign="Left"></asp:imagebutton>
			<asp:Label id="Label1" Font-Names="Trebuchet MS" Font-Size="X-Small" ForeColor="Red" style="Z-INDEX: 117; LEFT: 160px; POSITION: absolute; TOP: 373px"
				runat="server">* Indicates required fields.</asp:Label>
			<asp:RequiredFieldValidator id="ValRFirstName" style="Z-INDEX: 118; LEFT: 152px; POSITION: absolute; TOP: 136px"
				runat="server" ControlToValidate="txtFirstName" ErrorMessage="*" Height="8px" Width="8px"></asp:RequiredFieldValidator>
			<asp:RegularExpressionValidator id="ValREPhone" style="Z-INDEX: 119; LEFT: 480px; POSITION: absolute; TOP: 208px"
				runat="server" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}" ControlToValidate="txtPhone" ErrorMessage="Please submit the phone number as (999) 999-9999"
				Font-Size="X-Small" Font-Names="Trebuchet MS" Height="34px" Width="166px"></asp:RegularExpressionValidator>
		</FORM>
	</body>
</HTML>
